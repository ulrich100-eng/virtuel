# import pytest
# from Api.changerequest.testsperf.api_change import Apichange
...
# def test_postchangerequest_10_requests(api_change):
...
# # def test_postchangerequest_100_requests(api_change):
...
# #         response_times.append(response_time)
# #         print(f"Response : {response_times} secondes")
# #         avg_time = mean(response_times)
# #         print(f"Temps de réponse moyen : {avg_time} secondes")
...
# # def test_postchangerequest_500_requests(api_change):
...
# # def test_postchangerequest_1000_requests(api_change):
